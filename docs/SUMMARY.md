...
-   [Templates](internal-developers/templates/README.md)
    -   [BlockTemplateController class](internal-developers/templates/block-template-controller.md)
    -   [ClassicTemplate class](internal-developers/templates/classic-template.md)
