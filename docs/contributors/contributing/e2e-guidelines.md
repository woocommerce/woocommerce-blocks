...
The blockThemeWithGlobalSideEffects project runs the tests with the suffix *block_theme.side_effects_*. These tests have side effects that can potentially impact other end-to-end (E2E) tests. Due to the nature of these tests and their potential impact, they are not executed in parallel with other tests.
