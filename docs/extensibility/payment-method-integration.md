...
-   `billing`: This object contains everything related to billing - `billingData`, `setBillingData`, `cartTotal`, `currency`, `cartTotalItems`, `displayPricesIncludingTax`, `appliedCoupons`, `customerId`
