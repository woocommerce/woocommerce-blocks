...
```js
registerExpressPaymentMethod( ( ExpressPaymentMethodConfig ) => new ExpressPaymentMethodConfig( options ) );
```
...
```js
registerPaymentMethod( ( PaymentMethodConfig ) => new PaymentMethodConfig( options ) );
```
