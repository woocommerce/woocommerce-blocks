...
-   `__EXPERIMENTAL_CART_ITEM_PRICE_FILTER` constant which maps to the `wcBlocks.__experimental_cart_item_price_filter` hook name. Used to filter the cart item price in the Cart and Checkout blocks.
