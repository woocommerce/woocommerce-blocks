...
-   `__experimental_woocommerce_blocks_checkout_update_order_from_request` hook that allows developers to data passed in request (via ExtendRestAPI) to update order ([experimental hook](https://github.com/woocommerce/woocommerce-gutenberg-products-block/blob/d469a45d572f2c52d7917707c492dfb905ddfac0/src/StoreApi/Routes/Checkout.php#L466-L477)).
