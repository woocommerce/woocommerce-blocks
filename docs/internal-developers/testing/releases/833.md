# Testing notes and ZIP for release 8.3.3

Zip file for testing: [woocommerce-gutenberg-products-block.zip](https://github.com/woocommerce/woocommerce-blocks/files/9633785/woocommerce-gutenberg-products-block.zip)
