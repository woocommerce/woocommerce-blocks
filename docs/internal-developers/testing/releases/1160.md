...
Zip file for testing: [woocommerce-gutenberg-products-block.zip](https://github.com/woocommerce/woocommerce-blocks/files/13416758/woocommerce-gutenberg-products-block.zip)
...
5. Ensure the **Pager** is enabled.
6. Verify that there's no Pager top or bottom margin both in the editor and frontend.

#### Editor

| Before | After |
| ------ | ----- |
|<img width="1091" alt="Single_Product_‹_Template_‹_Editor_‹_newproductgallery_—_WordPress" src="https://github.com/woocommerce/woocommerce-blocks/assets/905781/0ee137d3-a6bb-4b83-80f7-5b27e8e37c26">|<img width="1015" alt="Single_Product_‹_Template_‹_Editor_‹_newproductgallery_—_WordPress" src="https://github.com/woocommerce/woocommerce-blocks/assets/905781/5b851a4a-de03-4ca1-afc0-9a2a7ab93dbf">|

#### Frontend

| Before | After |
| ------ | ----- |
|<img width="1161" alt="V-Neck_T-Shirt_–_newproductgallery" src="https://github.com/woocommerce/woocommerce-blocks/assets/905781/8a7ed41a-47c6-4135-90b3-e00a8b80de43">|<img width="1032" alt="V-Neck_T-Shirt_–_newproductgallery" src="https://github.com/woocommerce/woocommerce-blocks/assets/905781/e9ec92cc-b7a2-4f73-af04-d59a90e2a148">|
