...
4. Verify it looks like in the screenshots below. Note: Product Rating color is a plugin feature, meaning that stars will appear black instead of yellow when testing in Core.
