...
Zip file for testing: [woocommerce-gutenberg-products-block.zip](https://github.com/woocommerce/woocommerce-blocks/files/11419990/woocommerce-gutenberg-products-block.zip)
...
3. In an incognito window, add an item to your cart and go to the Cart block.
...
1. Create a page and use the block inserter->patterns->WooCommerce and to insert the `Featured Category Triple` pattern.
2. Notice the preview should populate with 3 existing categories.
3. Update/save and check the frontend and ensure it is displaying close to the design from [#9045](https://github.com/woocommerce/woocommerce-blocks/issues/9045)

![image](https://user-images.githubusercontent.com/2132595/234938909-ca713141-f345-41fc-a1b6-20601116b427.png)
...
1. Create a new post
2. Add the "Single Product Block" to it
3. Make sure the title displayed in the editor is correct and matches the selected product
4. Make sure the title is correctly displayed on the frontend and matches the selected product (and not the title of the post you created).
