# Testing notes and ZIP for release 10.4.1

Zip file for testing: [woocommerce-gutenberg-products-block.zip](https://github.com/woocommerce/woocommerce-blocks/files/11704664/woocommerce-gutenberg-products-block.zip)
