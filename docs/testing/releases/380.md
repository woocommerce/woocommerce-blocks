...
0. Ensure the phone number field is enabled in block settings, then test 2 cases:
...
### Change delimiter used for spltChunks from tilde to hyphens. ([3360](https://github.com/woocommerce/woocommerce-gutenberg-products-block/pull/3360))
