...
Zip file for testing: [woocommerce-gutenberg-products-block.zip](https://github.com/woocommerce/woocommerce-blocks/files/8844666/woocommerce-gutenberg-products-block.zip)
...
1. Create a new page and add a `Featured Category` block.
...
### Remove Combobox patch. ([6465](https://github.com/woocommerce/woocommerce-blocks/pull/6465))
