// Copy-pasted the following snippet from https://github.com/WordPress/gutenberg/blob/1d9352f49fdaf58a9c6f32ee38571c30c6e21fb8/test/e2e/config/flaky-tests-reporter.ts
