	...
	block: {
		...
		*/
		...
		fillBillingDetails: async ( customerBillingDetails ) => {
			...
			await expect( page ).toFill( '#components-form-token-input-0', customerBillingDetails.country );
			...
			await expect( page ).toFill( '#components-form-token-input-1', customerBillingDetails.state );
		...
		fillShippingDetails: async ( customerShippingDetails ) => {
			...
			await expect( page ).toFill( '#components-form-token-input-2', customerShippingDetails.country );
			...
			await expect( page ).toFill( '#components-form-token-input-3', customerShippingDetails.state );
