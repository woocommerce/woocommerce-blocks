...
post_content=$(cat "${script_dir}/all-products.txt")
...
post_content=$(cat "${script_dir}/cart.txt")
...
post_content=$(cat "${script_dir}/checkout.txt")
post_id=$(wp-env run tests-cli -- wp post create \
	--porcelain \
	--menu_order=2 \
	--post_type=page \
...
post_content=$(cat "${script_dir}/my-account.txt")
post_id=$(wp-env run tests-cli -- wp post create \
	--porcelain \
	--menu_order=3 \
	--post_type=page \
...
post_content=$(cat "${script_dir}/all-reviews.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
if [ "$pa_color" ] && [ "$pa_size" ]; then
	post_content=$(cat "${script_dir}/active-filters.txt")
	wp-env run tests-cli -- wp post create \
		--post_status=publish \
		--post_author=1 \
...
post_content=$(cat "${script_dir}/mini-cart.txt")
wp-env run tests-cli wp -- post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-best-sellers.txt")
wp-env run tests-cli wp -- post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/products-by-attribute.txt")
wp-env run tests-cli wp -- post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/single-product.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/customer-account.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/featured-category.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/featured-product.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/handpicked-products.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-new.txt")
wp-env run tests-cli wp post create -- \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-on-sale.txt")
wp-env run tests-cli wp post create -- \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-category.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-categories.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-search.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/reviews-by-category.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/reviews-by-product.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
...
post_content=$(cat "${script_dir}/product-top-rated.txt")
wp-env run tests-cli -- wp post create \
	--post_status=publish \
	--post_author=1 \
