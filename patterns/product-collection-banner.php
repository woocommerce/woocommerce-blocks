...
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-columns alignwide has-background" style="background-color:#ffedf5">
		...
		<div class="wp-block-column" style="flex-basis:58%">
			<!-- wp:cover {"url":"<?php echo esc_url( plugins_url( 'images/pattern-placeholders/beach-sunlight-plastic-summer-vacation-holiday.png', dirname( __FILE__ ) ) ); ?>","dimRatio":20,"minHeight":430,"minHeightUnit":"px","isDark":false,"style":{"spacing":{"padding":{"top":"80px","right":"80px","bottom":"80px","left":"80px"}}}} -->
			<div class="wp-block-cover is-light" style="padding-top:80px;padding-right:80px;padding-bottom:80px;padding-left:80px;min-height:430px">
				...
				<img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( plugins_url( 'images/pattern-placeholders/beach-sunlight-plastic-summer-vacation-holiday.png', dirname( __FILE__ ) ) ); ?>" data-object-fit="cover" />
