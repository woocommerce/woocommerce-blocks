...
$images = PatternImagesHelper::get_pattern_images( 'woocommerce-blocks/discount-banner-with-image' );
?>
...
<div class="wp-block-columns alignwide are-vertically-aligned-center has-background" style="background-color:#254094;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
	...
	<div class="wp-block-column is-vertically-aligned-center">
		...
		<figure class="wp-block-image aligncenter size-full has-custom-border">
			<img src="<?php echo esc_url( PatternImagesHelper::get_image_url( $images, 0, 'images/pattern-placeholders/table-floor-interior-atmosphere-living-room-furniture-square-lg.png' ) ); ?>" alt="" style="border-top-left-radius:100px;border-top-right-radius:10px;border-bottom-left-radius:10px;border-bottom-right-radius:100px"/>
		</figure>
		<!-- /wp:image -->
	</div>
	<!-- /wp:column -->
