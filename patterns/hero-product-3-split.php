	...
	<div class="wp-block-column" style="flex-basis:66.66%">
		...
		<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile has-text-color has-background" style="color:#ffffff;background-color:#000000">
			<div class="wp-block-media-text__content">
				<!-- wp:group {"style":{"spacing":{"padding":{"top":"35px","left":"20px","right":"20px","bottom":"35px"}}},"layout":{"type":"flex","orientation":"vertical"}} -->
				<div class="wp-block-group" style="padding-top:35px;padding-right:20px;padding-left:20px;padding-bottom:35px;">
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button">
							<a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>" class="wp-block-button__link has-text-color has-background wp-element-button" style="color:#000000;background-color:#ffffff">Shop now</a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
