...
<div class="wp-block-columns alignwide" style="margin-top:0px;margin-bottom:80px">
	...
	<div class="wp-block-column">
		<!-- wp:cover {"url":"<?php echo esc_url( PatternsHelper::get_image_url( $images, 0, 'images/pattern-placeholders/man-person-winter-photography-guy-statue.jpg' ) ); ?>","dimRatio":0,"minHeight":800,"minHeightUnit":"px","isDark":false,"layout":{"type":"constrained"}} -->
		<div class="wp-block-cover is-light" style="min-height:800px">
			...
			<img
				...
				src="<?php echo esc_url( PatternsHelper::get_image_url( $images, 0, 'images/pattern-placeholders/man-person-winter-photography-guy-statue.jpg' ) ); ?>"
