...
<div class="wp-block-columns" style="padding:0">
	...
	<div class="wp-block-column" style="padding:0">
		...
		<!-- /wp:image -->
		<!-- wp:group {"style":{"spacing":{"padding":"0px","blockGap":"0px","margin":{"top":"30px","bottom":"20px","left":"28%"}}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
		<div class="wp-block-group is-content-justification-center" style="margin-top:30px;margin-bottom:20px;margin-left:28%;padding:0">
