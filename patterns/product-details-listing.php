	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column"><!-- wp:post-featured-image {"height":"490px"} /-->
			...
			<div class="wp-block-group">
				<!-- wp:woocommerce/product-rating-stars {"isDescendentOfSingleProductBlock":true,"textColor":"luminous-vivid-amber"} /-->
				<!-- wp:woocommerce/product-rating-counter {"isDescendentOfSingleProductBlock":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast"}}},"typography":{"fontSize":"14px"},"spacing":{"padding":{"bottom":"2px"}}}} /-->
			</div>
			<!-- /wp:group -->
