...
<div class="wp-block-group" style="padding-top:1rem;padding-bottom:2rem;padding-left:0px"><!-- wp:site-logo {"shouldSyncIcon":true} /--></div><!-- wp:site-title /-->
<!-- /wp:group -->
