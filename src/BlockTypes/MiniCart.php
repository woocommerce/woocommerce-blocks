...
class MiniCart extends AbstractBlock {
	...
	protected function get_markup() {
		...
		$icon_file = new DOMDocument();
		$icon_file->load( __DIR__ . '/../../assets/js/blocks/cart-checkout/mini-cart/quantity-badge/cart.svg' );
		$icon        = $icon_file->saveHTML( $icon_file->getElementsByTagName( 'svg' )[0] );
