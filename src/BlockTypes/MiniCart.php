...
class MiniCart extends AbstractBlock {
	...
	public function register_auto_insert( $hooked_blocks, $position, $anchor_block, $context ) {
		 ...
		 * @since $VID:$
		 */
		$pattern_exclude_list = apply_filters( 'experimental_woocommerce_blocks_mini_cart_auto_insert_pattern_exclude_list', [] );
		 ...
		 * @since $VID:$
		 */
		$theme_include_list = apply_filters( 'woocommerce_blocks_mini_cart_auto_insert_pattern_include_list', [ 'Twenty Twenty-Four' ] );
