...
class RoutesController {
	...
	protected function initialize() {
		$this->routes = [
			...
			'cart-update-customer-address' => new Routes\CartUpdateCustomerAddress( $this->schemas->get( 'cart' ), $this->schemas->get( 'shipping-address' ), $this->schemas->get( 'billing-address' ) ),
