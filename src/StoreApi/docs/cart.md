...
If you want to add filter or supplemental cart item data, before it is passed into `CartController::add_to_cart` use the `woocommerce_store_api_add_to_cart_data` filter, documented on the [Filters page](https://github.com/woocommerce/woocommerce-blocks/blob/4d1c295a2bace9a4f6397cfd5469db31083d477a/docs/third-party-developers/extensibility/hooks/filters.md).
