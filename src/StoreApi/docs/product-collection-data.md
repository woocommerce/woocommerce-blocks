...
| `min_price`                  | number |    No    | Sets the min price for a products query. Required to properly filter products without Store API |
| `max_price`                  | number |    No    | Sets the max price for a products query. Required to properly filter products without Store API |
