...
| `min_price`                                 | string  |    no    | Limit result set to products based on a minimum price, provided using the smallest unit of the currency. The price needs to include 2 decimals (ie. 100 will be 10000).    |
| `max_price`                                 | string  |    no    | Limit result set to products based on a maximum price, provided using the smallest unit of the currency. The price needs to include 2 decimals (ie. 100 will be 10000).    |
