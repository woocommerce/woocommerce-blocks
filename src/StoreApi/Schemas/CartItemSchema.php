...
class CartItemSchema extends ProductSchema {
	...
	public function get_properties() {
		return [
			...
			'quantity_min'       => [
				'description' => __( 'The minimum quantity of this item in the cart.', 'woo-gutenberg-products-block' ),
				'type'        => 'integer',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			...
			'quantity_step'       => [
				'description' => __( 'The quantity step of this item in the cart.', 'woo-gutenberg-products-block' ),
				'type'        => 'integer',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
	...
	public function get_item_response( $cart_item ) {
		...
		return [
			...
			'quantity_min'         => isset( $cart_item['quantity_min'] ) && ! $product->is_sold_individually() ? wc_stock_amount( $cart_item['quantity_min'] ) : 1,
			'quantity_step'        => isset( $cart_item['quantity_step'] ) && ! $product->is_sold_individually() ? wc_stock_amount( $cart_item['quantity_step'] ) : 1,
