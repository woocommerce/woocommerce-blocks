...
class CartItemSchema extends ProductSchema {
	...
	public function get_item_response( $cart_item ) {
		...
		return [
			...
			'quantity_min'         => isset( $cart_item['quantity_min'] ) ? wc_stock_amount( $cart_item['quantity_min'] ) : 1,
			'quantity_step'        => isset( $cart_item['quantity_step'] ) ? wc_stock_amount( $cart_item['quantity_step'] ) : 1,
