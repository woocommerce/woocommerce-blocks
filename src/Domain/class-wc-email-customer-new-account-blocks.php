<?php
/**
 * Class WC_Email_Customer_New_Account_Blocks file.
 *
...
if ( ! class_exists( 'WC_Email_Customer_New_Account_Blocks', false ) ) :
	 ...
	 * @extends     WC_Email
	 */
	class WC_Email_Customer_New_Account_Blocks extends \WC_Email {
...
return new WC_Email_Customer_New_Account_Blocks();
