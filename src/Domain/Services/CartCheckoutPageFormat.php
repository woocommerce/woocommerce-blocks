...
class CartCheckoutPageFormat {
	...
	// This includes hard-coded default inner blocks for empty cart view.
	// The default content is different from the block; we don't have the
	// "Browse store" link, so we can avoid rendering a link to (dynamic)
	// shop page.
	const CART_CONTENT_BLOCK = '<!-- wp:woocommerce/cart --><div class="wp-block-woocommerce-cart is-loading">
<!-- wp:image {"align":"center","sizeSlug":"small"} -->
