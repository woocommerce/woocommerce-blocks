...
class ProductSchema extends AbstractSchema {
	...
	public function get_item_response( $product ) {
		return [
			...
			'description'    => $this->prepare_html_response( apply_filters( 'woocommerce_short_description', $product->get_short_description() ? $product->get_short_description() : wc_trim_string( $product->get_description(), 400 ) ) ),			'on_sale'        => $product->is_on_sale(),
