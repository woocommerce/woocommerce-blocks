		...
		( select, { dispatch } ) => {
			...
			if ( isEditor ) {
				return {
					...
					isLoadingRates: false,
					cartHasShippingAddress: previewCart.has_shipping_address,
					cartHasBillingAddress: previewCart.has_billing_address,
			...
			return {
				...
				isLoadingRates,
				cartHasShippingAddress: cartData.hasShippingAddress,
				cartHasBillingAddress: cartData.hasBillingAddress,
