...
import { useStoreNoticesWithSnackbarContext } from '@woocommerce/base-context/providers';

export const useStoreNoticesWithSnackbar = () => {
	const {
		notices,
		createNotice,
		removeNotice,
		...
		setIsSuppressed,
	} = useStoreNoticesWithSnackbarContext();
