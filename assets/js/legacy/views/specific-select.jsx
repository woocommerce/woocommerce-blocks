...
class ProductSpecificSearchResults extends Component {
	...
	getQuery() {
		...
		return '/wgbp/v3/products?per_page=10&status=publish&search=' + this.props.searchString;
	}
...
class ProductSpecificSelectedProducts extends Component {
	...
	getQuery() {
		...
		return uncachedProducts.length ? '/wgbp/v3/products?include=' + uncachedProducts.join( ',' ) : '';
	}
