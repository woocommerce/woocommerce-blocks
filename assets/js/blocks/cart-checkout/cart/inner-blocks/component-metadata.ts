...
import ORDER_SUMMARY_SUBTOTAL from './order-summary-subtotal-block/block.json';
import ORDER_SUMMARY_TOTAL from './order-summary-total-block/block.json';
import ORDER_SUMMARY_FEE from './order-summary-fee-block/block.json';
