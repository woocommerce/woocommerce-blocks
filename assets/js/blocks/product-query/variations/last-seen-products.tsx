...
export const INNER_BLOCKS_TEMPLATE: InnerBlockTemplate[] = [
	[
		...
		{
			level: 2,
			content: __( 'Last seen products', 'woo-gutenberg-products-block' ),
		},
	],
	[
		'core/post-template',
		{
			...
			...( postTemplateHasSupportForGridView && {
				layout: { type: 'grid', columnCount: 10 },
			} ),
		},
		[
			[
...
registerBlockSingleProductTemplate( {
	...
	blockSettings: {
		description: __(
			'Display the last 10 product visited.',
			'woo-gutenberg-products-block'
		),
		name: 'Last Visited Products Controls',
		title: __(
			'Last Visited Products Controls',
			'woo-gutenberg-products-block'
		),
