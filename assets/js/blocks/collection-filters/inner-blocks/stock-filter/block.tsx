...
import { DisplayOption, Current, BlockProps } from './types';
...
const Block = ( {
	...
	const allowsMultipleOptions = selectType !== 'single';
	...
	const isLoading =
		( ! isPreview && ! STOCK_STATUS_OPTIONS.current ) ||
