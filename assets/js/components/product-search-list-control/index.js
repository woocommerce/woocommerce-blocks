...
/**
 * Component to display a searchable, selectable list of products.
 */
export class ProductSearchListControl extends Component {
	constructor() {
		super( ...arguments );
	...
	renderListSection() {
		...
		if ( isLoading ) {
			return (
				<div className="woocommerce-product-search-list__list is-loading">
					<Spinner />
				</div>
			);
		}
		...
		if ( ! list.length ) {
			return (
				<div className="woocommerce-product-search-list__list is-not-found">
					<span className="woocommerce-product-search-list__not-found-icon">
						<Gridicon
							icon="notice-outline"
							role="img"
							aria-hidden="true"
					...
					<span className="woocommerce-product-search-list__not-found-text">
		...
		return (
			<MenuGroup
				label={ messages.list }
				className="woocommerce-product-search-list__list"
			>
	...
	renderSelectedSection() {
		...
		return (
			<div className="woocommerce-product-search-list__selected">
				<div className="woocommerce-product-search-list__selected-header">
	...
	render() {
		...
		return (
			<div className={ `woocommerce-product-search-list ${ className }` }>
				{ this.renderSelectedSection() }

				<div className="woocommerce-product-search-list__search">
					<TextControl
...
ProductSearchListControl.propTypes = {
	/**
