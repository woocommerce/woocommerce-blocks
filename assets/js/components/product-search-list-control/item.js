...
const SearchListItem = ( {
	...
	const classes = [ className, 'woocommerce-product-search-list__item' ];
	...
	return (
		<MenuItem
			...
			{ ...props }
		>
			<span className="woocommerce-product-search-list__item-state">
				{ getInteractionIcon( isSingle, isSelected ) }
			</span>

			<span className="woocommerce-product-search-list__item-label">
				{ hasBreadcrumbs ? (
					<span className="woocommerce-product-search-list__item-prefix">
						{ getBreadcrumbsForDisplay( item.breadcrumbs ) }
					</span>
				) : null }
				<span
					className="woocommerce-product-search-list__item-name"
			...
			{ !! showCount && (
				<span className="woocommerce-product-search-list__item-count">
					{ item.count }
				</span>
			) }
		</MenuItem>
